...
public class Exercises {
	...
	public String extraEnd(String str) {
		String lastTwo = str.substring(str.length() - 2) + str.substring(str.length() - 2) + str.substring(str.length() - 2);
	...
	public boolean hasBad(String str) {
		...
		return false;
			...
			return ((str.substring(0,3).contentEquals("bad")) || str.subSequence(1, 4).equals("bad"));
		}
	}
