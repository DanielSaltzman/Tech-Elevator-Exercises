...
INSERT INTO employee(first_name, last_name, gender, date_of_birth, date_of_hire, department) values ('Master', 'Chief', 'Male', '1988-06-19', '2019-02-10', 'Black Ops');
INSERT INTO employee(first_name, last_name, gender, date_of_birth, date_of_hire, department) values ('John', 'Wick', 'Male', '1980-01-30', '2019-02-04', 'Black Ops');
INSERT INTO employee(first_name, last_name, gender, date_of_birth, date_of_hire, department) values ('Dean', 'Winchester', 'Male', '1980-04-15', '2019-02-04', 'Special Ops');
INSERT INTO employee(first_name, last_name, gender, date_of_birth, date_of_hire, department) values ('Sammy', 'Winchester', 'Male', '1982-09-20', '2018-06-10', 'Special Ops');
INSERT INTO employee(first_name, last_name, gender, date_of_birth, date_of_hire, department) values ('James', 'Bond', 'Male', '1960-03-10', '2004-08-15', 'Video Games');
INSERT INTO employee(first_name, last_name, gender, date_of_birth, date_of_hire, department) values ('Link', 'Zelda', 'Male', '1985-11-11', '2002-12-22', 'Video Games');
INSERT INTO employee(first_name, last_name, gender, date_of_birth, date_of_hire, department) values ('Scooby', 'Doo', 'Male', '1972-02-16', '2008-11-26', 'Video Games');
INSERT INTO employee(first_name, last_name, gender, date_of_birth, date_of_hire, department) values ('Logan', 'Wolverine', 'X-Man', '1975-09-14', '2010-10-09', 'Black Ops');
