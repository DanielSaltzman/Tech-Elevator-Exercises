...
public class Park {
    ...
    private List<Park> surveyResults;
	...
	public void setSurveyResults(List<Park> surveyResults) {
	...
	public void setMilesoftrail(float milesoftrial) {
		this.milesoftrail = milesoftrial;
	}
